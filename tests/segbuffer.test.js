...
describe('Segbuffer', function() {
  ...
  it('should get option82 sub-options correctly for vendor cisco', function() {

    var vendor = "cisco";

    // Option82 with Sub-Option 1 first
    var sb_1 = new SeqBuffer(new Buffer([0x52, 0x19, 0x01, 0x0a, 0x43, 0x49, 0x52, 0x43, 0x55, 0x49, 0x54, 0x5f, 0x49, 0x44, 0x02, 0x0b, 0x01, 0x09, 0x52, 0x45, 0x4d, 0x4f, 0x54, 0x45, 0x5f, 0x49, 0x44]));
    
    sb_1.getSubOptions(vendor).should.be.deepEqual({ circuitId: 'CIRCUIT_ID', remoteId: 'REMOTE_ID' });

    // Option82 with Sub-Option 2 first
    var sb_2 = new SeqBuffer(new Buffer([0x52, 0x19, 0x02, 0x0b, 0x01, 0x09, 0x52, 0x45, 0x4d, 0x4f, 0x54, 0x45, 0x5f, 0x49, 0x44, 0x01, 0x0a, 0x43, 0x49, 0x52, 0x43, 0x55, 0x49, 0x54, 0x5f, 0x49, 0x44]));
    
    sb_2.getSubOptions(vendor).should.be.deepEqual({ circuitId: 'CIRCUIT_ID', remoteId: 'REMOTE_ID' });
  });
